...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'djstripe_customer', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['emailuser.EmailUser'], unique=True, null=True))
        # Adding field 'CurrentSubscription.metadata'
        db.add_column(u'djstripe_currentsubscription', 'metadata',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CurrentSubscription.metadata'
        db.delete_column(u'djstripe_currentsubscription', 'metadata')
    ...
    models = {
        ...
        u'djstripe.customer': {
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'stripe_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['emailuser.EmailUser']", 'unique': 'True', 'null': 'True'})
        },
        u'djstripe.event': {
